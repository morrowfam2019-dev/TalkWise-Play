...
export const LISTEN_RECIPES: ListenRecipe[] = [
  // --- Animals -------------------------------------------------------------
  {
    ...
    family: "animal",
    layers: [
      tone({ wave: "sawtooth", freq: 320, sweepTo: 170, duration: 0.16, gain: 0.16 }),
      noise({ duration: 0.12, gain: 0.07, filterHz: 900, shape: "decay" }),
      tone({ wave: "sawtooth", freq: 300, sweepTo: 150, duration: 0.16, delay: 0.3, gain: 0.15 }),
      noise({ duration: 0.12, delay: 0.3, gain: 0.06, filterHz: 900, shape: "decay" }),
    ],
  },
  {
    id: "cat-meow",
    ...
    family: "animal",
    layers: [
      tone({ wave: "sawtooth", freq: 520, sweepTo: 760, duration: 0.22, gain: 0.11, wobbleDepth: 18, wobbleHz: 9 }),
      tone({ wave: "sawtooth", freq: 760, sweepTo: 420, duration: 0.34, delay: 0.2, gain: 0.11, wobbleDepth: 22, wobbleHz: 7 }),
    ],
  },
  {
    id: "cow-moo",
    ...
    family: "animal",
    layers: [
      tone({ wave: "sawtooth", freq: 150, sweepTo: 190, duration: 0.4, gain: 0.14, wobbleDepth: 6, wobbleHz: 5 }),
      tone({ wave: "sawtooth", freq: 190, sweepTo: 120, duration: 0.6, delay: 0.36, gain: 0.13, wobbleDepth: 5, wobbleHz: 4 }),
    ],
  },
  {
    id: "duck-quack",
    ...
    family: "animal",
    layers: [
      tone({ wave: "square", freq: 420, sweepTo: 300, duration: 0.12, gain: 0.09, wobbleDepth: 40, wobbleHz: 26 }),
      tone({ wave: "square", freq: 420, sweepTo: 290, duration: 0.12, delay: 0.22, gain: 0.09, wobbleDepth: 40, wobbleHz: 26 }),
    ],
  },
  {
    id: "bird-tweet",
    ...
    family: "animal",
    layers: [
      tone({ wave: "sine", freq: 1900, sweepTo: 2900, duration: 0.09, gain: 0.09 }),
      tone({ wave: "sine", freq: 2600, sweepTo: 1800, duration: 0.09, delay: 0.1, gain: 0.09 }),
      tone({ wave: "sine", freq: 2100, sweepTo: 3100, duration: 0.1, delay: 0.28, gain: 0.08 }),
    ],
  },
  {
    id: "lion-roar",
    ...
    family: "animal",
    layers: [
      tone({ wave: "sawtooth", freq: 110, sweepTo: 78, duration: 0.85, gain: 0.15, wobbleDepth: 9, wobbleHz: 17 }),
      noise({ duration: 0.85, gain: 0.09, filterHz: 320, filterQ: 1.4, shape: "swell" }),
    ],
  },
  {
    id: "sheep-baa",
    ...
    family: "animal",
    layers: [
      tone({ wave: "sawtooth", freq: 430, sweepTo: 380, duration: 0.62, gain: 0.11, wobbleDepth: 34, wobbleHz: 15 }),
    ],
  },
  {
    id: "frog-ribbit",
    ...
    family: "animal",
    layers: [
      tone({ wave: "square", freq: 230, sweepTo: 300, duration: 0.1, gain: 0.1, wobbleDepth: 30, wobbleHz: 32 }),
      tone({ wave: "square", freq: 180, sweepTo: 140, duration: 0.16, delay: 0.13, gain: 0.1, wobbleDepth: 24, wobbleHz: 28 }),
    ],
  },
  ...
  // --- Vehicles ------------------------------------------------------------
  {
    ...
    layers: [
      ...
      tone({ wave: "square", freq: 440, duration: 0.16, delay: 0.26, gain: 0.09 }),
      tone({ wave: "square", freq: 554, duration: 0.16, delay: 0.26, gain: 0.07 }),
    ],
  },
  {
    id: "train-whistle",
  ...
  },
  {
    ...
    family: "vehicle",
    layers: [
      tone({ wave: "sine", freq: 700, sweepTo: 1100, duration: 0.4, gain: 0.09 }),
      tone({ wave: "sine", freq: 1100, sweepTo: 700, duration: 0.4, delay: 0.4, gain: 0.09 }),
      tone({ wave: "sine", freq: 700, sweepTo: 1100, duration: 0.4, delay: 0.8, gain: 0.09 }),
    ],
  },
  {
    id: "plane-woosh",
    ...
    family: "vehicle",
    layers: [
      noise({ duration: 1.1, gain: 0.11, filterHz: 700, filterQ: 0.8, shape: "swell" }),
      tone({ wave: "sawtooth", freq: 90, sweepTo: 140, duration: 1.1, gain: 0.05 }),
    ],
  },
  {
    id: "boat-horn",
  ...
  },
  {
    ...
    layers: [
      ...
      noise({ duration: 0.09, delay: 0.12, gain: 0.12, filterHz: 380, shape: "decay" }),
      noise({ duration: 0.09, delay: 0.24, gain: 0.12, filterHz: 380, shape: "decay" }),
      noise({ duration: 0.09, delay: 0.36, gain: 0.12, filterHz: 380, shape: "decay" }),
      noise({ duration: 0.09, delay: 0.48, gain: 0.12, filterHz: 380, shape: "decay" }),
      noise({ duration: 0.09, delay: 0.6, gain: 0.12, filterHz: 380, shape: "decay" }),
    ],
  },
  ...
  },
  {
    ...
    layers: [
      ...
      tone({ wave: "sine", freq: 1318, duration: 0.06, delay: 0.08, gain: 0.08 }),
      tone({ wave: "sine", freq: 1046, duration: 0.06, delay: 0.16, gain: 0.08 }),
      tone({ wave: "sine", freq: 1318, duration: 0.06, delay: 0.24, gain: 0.08 }),
      tone({ wave: "sine", freq: 1046, duration: 0.06, delay: 0.44, gain: 0.08 }),
      tone({ wave: "sine", freq: 1318, duration: 0.06, delay: 0.52, gain: 0.08 }),
    ],
  },
  {
    id: "clock-tick",
    ...
    family: "household",
    layers: [
      noise({ duration: 0.03, gain: 0.14, filterHz: 2600, filterQ: 3, shape: "decay" }),
      noise({ duration: 0.03, delay: 0.5, gain: 0.12, filterHz: 1700, filterQ: 3, shape: "decay" }),
      noise({ duration: 0.03, delay: 1.0, gain: 0.14, filterHz: 2600, filterQ: 3, shape: "decay" }),
      noise({ duration: 0.03, delay: 1.5, gain: 0.12, filterHz: 1700, filterQ: 3, shape: "decay" }),
    ],
  },
  {
    id: "knock",
    ...
    family: "household",
    layers: [
      noise({ duration: 0.07, gain: 0.16, filterHz: 260, filterQ: 2, shape: "decay" }),
      noise({ duration: 0.07, delay: 0.2, gain: 0.16, filterHz: 260, filterQ: 2, shape: "decay" }),
      noise({ duration: 0.07, delay: 0.4, gain: 0.14, filterHz: 240, filterQ: 2, shape: "decay" }),
    ],
  },
  {
    id: "water-drip",
    ...
    family: "household",
    layers: [
      tone({ wave: "sine", freq: 900, sweepTo: 1700, duration: 0.07, gain: 0.11 }),
      tone({ wave: "sine", freq: 760, sweepTo: 1500, duration: 0.07, delay: 0.45, gain: 0.1 }),
      tone({ wave: "sine", freq: 980, sweepTo: 1800, duration: 0.07, delay: 0.9, gain: 0.11 }),
    ],
  },
  ...
  // --- Nature --------------------------------------------------------------
  {
    ...
    family: "nature",
    layers: [
      noise({ duration: 1.4, gain: 0.09, filterHz: 3200, filterQ: 0.6, shape: "flat" }),
      noise({ duration: 1.4, gain: 0.04, filterHz: 900, filterQ: 0.6, shape: "flat" }),
    ],
  },
  {
    id: "wind",
    ...
    family: "nature",
    layers: [
      noise({ duration: 1.5, gain: 0.1, filterHz: 480, filterQ: 1.6, shape: "swell" }),
    ],
  },
  {
    id: "thunder",
    ...
    layers: [
      ...
      noise({ duration: 1.3, delay: 0.05, gain: 0.14, filterHz: 130, filterQ: 0.7, shape: "decay" }),
      tone({ wave: "sawtooth", freq: 62, sweepTo: 40, duration: 1.3, delay: 0.05, gain: 0.09 }),
    ],
  },
  ...
  // --- Instruments ---------------------------------------------------------
  {
    ...
    layers: [
      ...
      tone({ wave: "sine", freq: 160, sweepTo: 52, duration: 0.3, delay: 0.4, gain: 0.18 }),
      noise({ duration: 0.06, delay: 0.4, gain: 0.08, filterHz: 1900, shape: "decay" }),
    ],
  },
  {
    id: "bell",
  ...
  },
  {
    ...
    family: "instrument",
    layers: [
      tone({ wave: "sine", freq: 2200, duration: 0.5, gain: 0.08, wobbleDepth: 120, wobbleHz: 22 }),
      noise({ duration: 0.5, gain: 0.03, filterHz: 2600, filterQ: 4, shape: "flat" }),
    ],
  },
  {
    id: "guitar-strum",
    ...
    layers: [
      ...
      tone({ wave: "triangle", freq: 415, duration: 0.9, delay: 0.04, gain: 0.06 }),
      tone({ wave: "triangle", freq: 494, duration: 0.9, delay: 0.08, gain: 0.06 }),
      tone({ wave: "triangle", freq: 659, duration: 0.9, delay: 0.12, gain: 0.05 }),
    ],
  },
];

const RECIPE_BY_ID = new Map(LISTEN_RECIPES.map((recipe) => [recipe.id, recipe]));
