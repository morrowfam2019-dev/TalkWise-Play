  ...
  items: buildItems("action-time", [
    {
      ...
      action: "jump",
      phrase: "jump high",
      sentence: "The boy is jumping over the box.",
      tags: ["action", "move"],
    },
    {
      id: "run",
      ...
      action: "run",
      phrase: "run fast",
      sentence: "The girl is running to the tree.",
      tags: ["action", "move"],
    },
    {
      id: "clap",
      ...
      action: "clap",
      phrase: "clap loud",
      sentence: "We are clapping our hands.",
      tags: ["action"],
    },
    {
      id: "spin",
      ...
      action: "spin",
      phrase: "spin around",
      sentence: "The boy is spinning around.",
      tags: ["action", "move"],
    },
    {
      id: "eat",
    ...
    },
    {
      ...
      action: "sleep",
      phrase: "sleep well",
      sentence: "The baby is sleeping in the bed.",
      sound: "s",
      tags: ["action", "rest"],
    },
    {
      ...
      action: "wave",
      phrase: "wave hello",
      sentence: "The boy is waving to his friend.",
      sound: "w",
      tags: ["action", "hello"],
    },
    {
      ...
      action: "dance",
      phrase: "dance along",
      sentence: "The girl is dancing to the music.",
      tags: ["action", "move"],
    },
    {
      id: "drink",
      ...
      action: "drink",
      phrase: "drink water",
      sentence: "The boy is drinking his water.",
      tags: ["action", "food"],
    },
    {
      id: "sit",
      ...
      action: "sit",
      phrase: "sit down",
      sentence: "The girl is sitting on the chair.",
      sound: "s",
      tags: ["action", "rest"],
    },
  ]),
