...
/**
 * GAME-001 Speech Adventures — the game's own home screen.
 *
 * This is the adventure's front door, not TalkWise Play's: choosing a sound
 * and starting a run lives here, and the only way back out to the library is
 * the explicit "TalkWise Play" button. Nothing on this screen knows that
 * Speech Basketball exists.
 */
